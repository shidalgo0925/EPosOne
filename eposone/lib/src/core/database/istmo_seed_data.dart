...
Future<void> seedIstmoCatalog(Isar isar) async {
  ...
  Product p(
    ...
    String categoryId, {
    String? description,
    String fiscalCategoryCode = 'EXENTO',
  }) =>
      Product(
  ...
  final products = <Product>[
    ...
    p('cerveza_colon', 'Colón Lager', 3.75, cCervI,
        description: '4.1% · IBU 14 · Panameña pura',
        fiscalCategoryCode: FiscalCategory.itbms10.code),
    p('cerveza_chiriqui', 'Chiriquí Red Ale', 3.75, cCervI,
        description: '5.6% · IBU 28',
        fiscalCategoryCode: FiscalCategory.itbms10.code),
    p('cerveza_cocle', 'Coclé Caribbean Dunkel Weiss', 3.75, cCervI,
        description: '4.9% · IBU 12',
        fiscalCategoryCode: FiscalCategory.itbms10.code),
    p('cerveza_darien', 'Darién IPA', 3.75, cCervI,
        description: '5.9% · IBU 54',
        fiscalCategoryCode: FiscalCategory.itbms10.code),
    p('cerveza_bocas', 'Bocas Wheat Beer', 3.75, cCervI,
        description: '4.9% · IBU 13',
        fiscalCategoryCode: FiscalCategory.itbms10.code),
    ...
    p('cerveza_corona0', 'Corona 0%', 4.82, cCerv,
        fiscalCategoryCode: FiscalCategory.itbms7.code),
    ...
    p('beb_limonada', 'Limonada Clásica o Fresa', 3.21, cBeb,
        fiscalCategoryCode: FiscalCategory.exento.code),
  ...
  // Config operativa Istmo (precios incluyen ITBMS; restaurante con servicio)
